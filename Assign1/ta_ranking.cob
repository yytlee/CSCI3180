...
000000     01 REQ-COUNT PIC 9 VALUE 0.
000000     01 RANKING.
...
000000*    DISPLAY REQ-SKILL(INSTRU-COUNT) SKILL(
      *       CANDID-COUNT) INSTRU-COUNT
000000     IF INSTRU-COUNT = 4 THEN
000000        MOVE 1 TO INSTRU-COUNT
000000        MOVE 1 TO CANDID-COUNT
000000        ADD 1 TO SCORE
              DISPLAY "RQ " COURSE-ID SID
